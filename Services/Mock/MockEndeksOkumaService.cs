...
public class MockEndeksOkumaService : IEndeksOkumaService
{
    private static readonly List<EndeksOkuma> _okumalar = new()
    {
        ...
        new EndeksOkuma { EndeksOkumaId = 4, TuketimNoktasiId = 1004, SayacId = 5004, OkumaTarihi = new DateTime(2026, 4, 8), IlkEndeks = 16800, SonEndeks = 16800, TuketimMiktari = 0, OkumaTipi = "Manuel", Durum = "Sifir Tuketim", OkunamamaNedeni = "Tesisat Kapalı", CreatedAt = new DateTime(2026, 4, 8) },
        ...
        new EndeksOkuma { EndeksOkumaId = 6, TuketimNoktasiId = 1006, SayacId = 5006, OkumaTarihi = new DateTime(2026, 4, 12), IlkEndeks = 20100, SonEndeks = 22650, TuketimMiktari = 2550, OkumaTipi = "Manuel", Durum = "Anormal", AnomaliAciklamasi = "Aşırı Tüketim Artışı", CreatedAt = new DateTime(2026, 4, 12) },
